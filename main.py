...
def comeco():
  try:
    ...
    janela.configure(background = a)
    janela.geometry('400x300+200+200')
    texto_inicio = Label(janela, background = a, foreground = v, text = 'PLANNER - INÍCIO')
    texto_inicio.place(x = '150', y = '20')
    texto_login = Label(janela, background = a, foreground = v, text = '1 - Login')
    texto_login.place(x = '50', y = '50')
    texto_cadastro = Label(janela, background = a, foreground = v, text = '2 - Cadastro')
    texto_cadastro.place(x = '50', y = '70')
    texto_sistema = Label(janela, background = a, foreground = v, text = '3 - Ver sobre o sistema')
    texto_sistema.place(x = '50', y = '90')
    texto_bd = Label(janela, background = a, foreground = v, text = '4 - Banco de dados')
